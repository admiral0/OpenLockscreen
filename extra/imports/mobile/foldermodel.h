...
/**
 * @file foldermodel.h
 * @short Definition of Mobile::Launcher::FolderModel
 */

#ifndef MOBILE_LAUNCHER_FOLDERMODEL_H
#define MOBILE_LAUNCHER_FOLDERMODEL_H
...
Q_DECLARE_METATYPE(Mobile::Launcher::FolderModel *)

#endif // MOBILE_LAUNCHER_FOLDERMODEL_H
