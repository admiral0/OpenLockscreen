...
/**
 * @file packageinformationmodel.cpp
 * @short Implementation of Widgets::Info::PackageInformationModel
 */
...
/**
 * @internal
 * @short Private class for Widgets::Info::PackageInformationModel
 */
