 ...
 * @short Implementation of Widgets::ApplicationsModel
 *
 * This file contains the implemetation of the
 * Widgets::ApplicationsModel class and the declaration and
 * implementation of Widgets::ApplicationsModel::ApplicationsModelPrivate.
 */
