...
void TestWidgetProperties::testWidgetProperties()
{
    ...
    QCOMPARE(component->x(), builtComponent->x());
    QCOMPARE(component->y(), builtComponent->y());
    QCOMPARE(component->z(), builtComponent->z());
    QCOMPARE(component->width(), builtComponent->width());
    QCOMPARE(component->height(), builtComponent->height());
