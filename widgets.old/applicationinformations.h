 ...
 * @short Definition of Widgets::ApplicationInformations
 *
 * This file contains the definition of the
 * Widgets::ApplicationInformations class.
 */
...
public:
     ...
     *
     * This constructor is used to create a application
     * informations containing all the needed properties.
     *
     ...
     * @short Icon of the application
     *
     * This method is used to retrieve the icon of
     * the application.
     *
     ...
     * line used to run the application.
     *
...
Q_DECLARE_METATYPE(Widgets::ApplicationInformations *)
